<?php
class ControllerExtensionModuleInfiniteScroll extends Controller {
	private $error = array();
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/infinite_scroll', 'user_token=' . $this->session->data['user_token'], true)
		);

		$data['action'] = $this->url->link('extension/module/infinite_scroll', 'user_token=' . $this->session->data['user_token'], true);
	...
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/infinite_scroll')) {
